...
/**
 * NotFoundContent — Client component for404 page with context-aware messages.
 * Uses usePathname to determine the URL context.
 * Extracted from not-found page to allow it to be a Server Component.
 */
