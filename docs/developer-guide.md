...
src/
  ...
  hooks/                    usePolling, useRealtimeSync, useGoalMerge, useFileUpload, useModalA11y
  lib/                      api-helpers, auth.server, notify, rateLimit, sections, permissions…
...
- `MemberPermissions` has 5 boolean flags (`PERMISSION_KEYS`, with `PERMISSION_LABELS`).
