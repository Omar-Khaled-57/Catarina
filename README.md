<div>
  <img src="public/logo.png" alt="Catarina Logo" width="140" />
  <h1>Catarina</h1>
...
Each of the 4 sections has its own private space with goals, progress counters, step checklists, and comments. Members are scoped to their section(s), while admins have global visibility.
...
Rich notification system with pinning, marking as read, and audio playback support. Every team event — goal creation, step additions, member joins, deadline alerts — generates a notification.
...
│   ├── (auth)/              # Login page
│   ├── dashboard/
│   │   ├── [section]/       # Section goal pages (MARKETING, ART, etc.)
│   │   ├── admin/           # Admin panel (members, months, permissions)
...
└── seed.ts                  # Seed script (users, goals, notifications)
